...
export interface informations {
    ...
    obp7_to: string,
    obp7_periode: string,
    caae_periode_1: string,
    caae_periode_2: string,
    caae_periode_3: string,
    caae_periode_4: string,
    caae_periode_5: string,
    caae_periode_6: string,
    caae_periode_7: string,
    caae_periode_8: string,
    caae_periode_9: string,
    caae_periode_10: string,
    caae_periode_11: string,
    caae_periode_12: string,
    caae_ca_1: string,
    caae_ca_2: string,
    caae_ca_3: string,
    caae_ca_4: string,
